...
<%-- <body>
	<form action="/sss/draft/edit.do">
		<table>
			<tr>
				<td>编号</td>
				<td>${draft.dno}</td>
				<input type="hidden" id="dno" name="dno" value="${draft.dno}">
			</tr>
			<tr>
				<td>内容</td>
				<td><input type="text" id="content" name="content" value="${draft.content}">
				</td>
			</tr>
		</table>
	...
	<!-- /.container-fluid --> </nav>
      <div class="input-detail">
        ...
        <div class="page-header">
          <h3>草稿编辑<small>  edit you draft</small></h3>
        </div>
          <form>
            <div class="form-group">
              <!-- <label for="notice-title">公告标题</label> -->
              
              <input type="text" class="form-control" id="notice-title" placeholder="请填写公告标题" value="${draft.title }">
            </div>
            <div class="form-group">
              <!-- <label for="exampleInputPassword1">公告详情</label> -->
              <textarea  rows="15" type="text" class="form-control" id="notice-detail" placeholder="请填写公告详情">${ draft.content}</textarea>
            </div>
            <div class="form-group">
              ...
              <span class="display-selected-user label label-warning"></span>
            </div>
            
           	<%-- <a type="" href="/sss/draft/delete.do?dno=${dno}" class="btn btn-danger" id="">删除草稿</a> --%>
            <button type="" class="btn btn-danger" id="delete">删除草稿</button>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form>
                <div class="form-group">
                  <label for="notice-title">请选择用户:</label>
  ...
  var receiver = 0;
    ...
    $("#deploy").click(function(e){
	 ...
	 $("#delete").click(function(){
		 var r = confirm("是否确认删除此草稿？");
		 if(r){
		    window.location.href= "/sss/draft/delete.do?dno=${dno}";
			return false;
		 }else{
			 return false;
		 }
