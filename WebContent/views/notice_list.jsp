            ...
            <table class="table table-hover">
              ...
              <c:forEach items="${notice_list}" var="notice" varStatus="status">
                <tr>
                  ...
                  <td><a href="/sss/notice/detail.do?nno=${notice.nno}">${notice.title}</a></td>
                  <td>${notice.date}</td>
                  <c:if test="${notice.type==1 }"> <td>公司公告</td></c:if>
                  <c:if test="${notice.type==2 }"> <td>部门公告</td></c:if>
                  <c:if test="${notice.type==3 }"> <td>个人公告</td></c:if>
                </tr>
            </c:forEach>
